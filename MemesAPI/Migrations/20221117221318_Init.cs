        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MemeUserId = table.Column<string>(type: "varchar(255)", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MemeLike", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MemeLike_AspNetUsers_MemeUserId",
                        column: x => x.MemeUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "7f2443ad-1ee4-4133-858d-131e4137403e", null, "Admin", "ADMIN" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { "cf10ba0a-51dc-4c53-b6de-0f9f283fff74", null, "User", "USER" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "043377e4-9f2c-42d3-9d02-88ea5adcfae7", 0, null, "MemeUser", "duncancacerescartasso@gmail.com", true, 1000, false, null, "DUNCANCACERESCARTASSO@GMAIL.COM", "DUNCAN088", "AQAAAAEAACcQAAAAEOh6WZnRMGgwvJsjAZh9cR6NF5m2/Uc6OJuFAKt1rvJhGCEQu1R4h7cmWQkzuRj/oQ==", null, false, null, false, "duncan088", "", "" });
